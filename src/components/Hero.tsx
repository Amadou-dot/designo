...
export default function Hero() {
  return (
    <div className='bg-primary relative min-h-0 flex-grow overflow-clip bg-[url(../assets/bg-pattern-hero-home.svg)] bg-cover bg-left-top bg-no-repeat p-4 lg:flex lg:items-center lg:justify-center h-screen'>
